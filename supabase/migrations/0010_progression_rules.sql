-- Migration 0010: coluna progression_rules para dados estruturados de
-- progressão (regras do molde). A Fase 6 (replanejamento semanal) usará
-- este campo para ler deloads como dado estruturado em vez de inferir
-- por texto.

alter table public.training_plans
  add column if not exists progression_rules jsonb;

-- Atualiza a RPC save_training_plan para incluir progression_rules
-- no INSERT de training_plans (mantém compatibilidade com payloads
-- que não incluem o campo — null é o default).
