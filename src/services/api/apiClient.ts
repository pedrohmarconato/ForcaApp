...
// Re-exportado: consumidores existentes seguem importando do apiClient.
export { classifyApiError } from './apiErrors';
export type { ClassifiedApiError } from './apiErrors';
