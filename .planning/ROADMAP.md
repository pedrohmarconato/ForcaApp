...
- [x] **Phase 14: Fundação nativa** - Build nativo assinado no iPhone do dono + spike de App Groups que decide a arquitetura de estado
...
- [x] 14-01-PLAN.md — Decisão de bundle identifiers (D-06) + aprovação de legitimidade dos pacotes SUS

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 14-02-PLAN.md — Pipeline nativo completo (tracer) + scripts/verify-native-skeleton.sh

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 14-03-PLAN.md — ProvisioningBanner.tsx + leitura do provisioning profile (D-03)
- [x] 14-04-PLAN.md — scripts/resign.sh, rotina de reassinatura em 1 comando (D-01/D-02)
- [x] 14-05-PLAN.md — Preparação do spike de App Groups (entitlement temporária + build assinado)

**Wave 4** *(blocked on Wave 3 completion)*

- [x] 14-06-PLAN.md — Sessão 1 física: primeira instalação + Developer Mode + spike de App Groups

**Wave 5** *(blocked on Wave 4 completion)*

- [x] 14-07-PLAN.md — Registro da decisão do spike (14-SPIKE-APP-GROUPS.md) + revert/keep
...
- [x] 14-09-PLAN.md — Sessão 2 física: UAT de reassinatura + paridade com o PWA
...
- [x] 15-04-PLAN.md — Aponta `.env` para o Supabase de produção (todo dobrado `backend-supabase-producao-no-aparelho`)
...
- [x] 16-01-PLAN.md — Tracer + expansão: CompleteSetIntent/SkipRestIntent/AdjustRestIntent no caminho quente (bridge JS já viva)

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 16-02-PLAN.md — Reconciliação da fila do App Group no boot (cold-launch, drainIntentQueue + CAS por sessionLogId)
...
- [x] 16-08-PLAN.md — D2: setReps/setLoad persistem via saveDraft (+ applyServerSetLogs preserva reps/carga em andamento); D3: activateSet garante série ativa única
...
- [x] 17-06-PLAN.md — Pre-flight automatizado: suite completa + tsc + skeleton nativo + build Release
