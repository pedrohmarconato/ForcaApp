...
- [x] **Phase 3: Intercâmbio de modalidade de cardio** - Trocar um momento de cardio por outra modalidade aceita (escada, bike, remo) preservando a dose por tempo (completed 2026-08-13)
...
| 3. Intercâmbio de modalidade de cardio | 9/9 | Complete (re-verificação 8/8 + SECURED 15/15 + UAT rodada 3) | 2026-08-13 |
