...
| 5 | 17 | unrun-verify | src/components/session/SessionPlayer.tsx |  | 17-04 Task 2: a verificação original previa checagem manual do PWA (npx expo start --web, 390x844). Esse caminho ficou INEXEQUÍVEL: em 2026-08-19 o web foi executado de verdade e a aplicação crasha no mount com 'Cannot find native module LiveActivityModule' — root vazio, tela preta. Causa confirmada no código: modules/live-activity/index.ts:49 chama requireNativeModule no topo do módulo, sem guarda de Platform.OS; idem liveActivitySync.ts e liveActivityIntentBridge.ts. Quebrado desde a Fase 16 (3dabb0e feat 16-01); NÃO é regressão da Fase 17. Decisão do dono em 2026-08-19: o web/PWA não é mais superfície suportada na v1.3 (o milestone virou app nativo pessoal), então este crash fica registrado como consequência aceita, não como bug em aberto. A janela segue OPEN porque REG-01 continua sem verificação em superfície real: fechar exige o dono abrir a tela de sessão ativa no APP DO IPHONE (não a tela bloqueada), num exercício com histórico, e confirmar pré-preenchimento do histórico, ajuste só por +/-, marca de valor herdado e ausência de teclado ou overflow. A evidência anterior (réplica de CSS/box-model em Chromium via Playwright, 0 overflow em 390x844 e 360px) segue válida como prova de layout, mas não é o app rodando. | resolved | Fechada em 2026-08-19 pelo dono: verificacao feita na tela de sessao ativa do APP DO IPHONE (nao no PWA, que deixou de ser superficie suportada na v1.3), com build assinado do HEAD instalado no aparelho as 10:12:33 do mesmo dia. Dono reportou aprovado. Criterio 1 do ROADMAP / REG-01 dado como verificado em superficie real. | 2026-08-19T02:07:27.217Z | 2026-08-19T15:37:59.000Z |
...
[
  ...
  },
  {
    ...
    "status": "resolved",
    "reason": "Fechada em 2026-08-19 pelo dono: verificacao feita na tela de sessao ativa do APP DO IPHONE (nao no PWA, que deixou de ser superficie suportada na v1.3), com build assinado do HEAD instalado no aparelho as 10:12:33 do mesmo dia. Dono reportou aprovado. Criterio 1 do ROADMAP / REG-01 dado como verificado em superficie real.",
